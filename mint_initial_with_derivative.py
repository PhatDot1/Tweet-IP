#!/usr/bin/env python3
"""
mint_initial.py - Exact 1:1 port of TypeScript mint.ts script

Requirements:
pip install web3 python-dotenv eth-account

Usage:
python mint_initial.py
"""
...
async def main():
    ...
    # 2) Read back the very first collection
    ...
    mint_tx_hash = send_transaction(
        factory.functions.registerTweetAsset(
            ...
            0,
            ["#test"],
            [f"@bobby3"],  # THIS MUST CHANGE EACH RUN
            "https://example.com/avatar.jpg",
            f"https://twitter.com/alice/status/333",  # THIS MUST CHANGE EACH RUN
            "333",  # THIS MUST CHANGE EACH RUN
    ...
    # 8) Create a derivative work
    await create_derivative_work(collection, ip_asset_id)
